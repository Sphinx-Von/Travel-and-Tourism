...
public class Destination extends JFrame implements Runnable{
    ...
    JLabel[] jlabel = new JLabel[]{j1, j2, j3, j4, j5, j6, j7, j8, j9, j10};
    JLabel caption;
   

    public void run(){
        String[] text = new String[]{"JW Marriott Hotel","Mandarian Oriental Hotel", "Four Season Hotel", "Raddission Hotel", "THe Bay Club Hotel", "Breeze Blow Hotel", "The Taj Hotel", "Happy Morning Motel", "River View Hotel", "Manvali Pahunchar"};
